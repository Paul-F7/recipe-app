...
const demoVideo = 'https://pub-3ce29bd0907b4d8faca7717476022259.r2.dev/usethis.mp4'
    ...
    <div className="app">
      ...
      <main className="main">
        <div className="content">
          ...
          {/* Bottom text - Feature highlights + Metrics + CTA */}
          <div className="text-bottom">
            ...
            <div className="cta-buttons">
              <a
                ...
                href="https://apps.apple.com/us/app/flavorflick/id6760682060"
                target="_blank"
                rel="noreferrer"
              >
